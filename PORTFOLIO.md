...
| [Gate 3: First Class, Lifetime, and Basic RAII](./01_phase0-cpp-foundations/gate3-first-class-lifetime-and-basic-raii/README.md) | a tiny class with constructor/destructor logging and scope-bound lifetime behavior | [solution/main.cpp](./01_phase0-cpp-foundations/gate3-first-class-lifetime-and-basic-raii/solution/main.cpp) |
| [Gate 4: Phase 0 Integration Project](./01_phase0-cpp-foundations/gate4-phase0-integration-project/README.md) | a bounded integration program combining I/O, storage, parameter passing, cleanup, and lifetime logging | [solution/main.cpp](./01_phase0-cpp-foundations/gate4-phase0-integration-project/solution/main.cpp) |
