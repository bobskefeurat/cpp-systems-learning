...
- Use [R-003 Card](../../../00_system/resources/resource_cards/R-003.md) only if the exact wording of lifetime or destructor behavior is still unclear.
...
- why destructor-based cleanup is the basic RAII idea in this gate
